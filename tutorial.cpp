...
int main(int argc,char* argv[]) {
  ...
  //Load & save enrollments table
  {
    ...
    RelevantCols.Add(1); 
    //Load table
    PTable P_enrollments = TTable::LoadSS(PAA, src_file, &Context, RelevantCols);
  ...
  //Load & save friends table
 {
    ...
    RelevantCols.Add(1); 
    //Load table
    PTable P_friends = TTable::LoadSS(PAA, src_file, &Context, RelevantCols);
  ...
  //Load & save advisors table
 {
    ...
    RelevantCols.Add(1); 
    //Load table
    PTable P_advisors = TTable::LoadSS(PAA, src_file, &Context, RelevantCols);
  ...
  //Load & save prereqs table
 {
    ...
    RelevantCols.Add(1); 
    //Load table
    PTable P_prereqs = TTable::LoadSS(PAA, src_file, &Context, RelevantCols);
  ...
  //Load & save instructors table
 {
    ...
    RelevantCols.Add(1); 
    //Load table
    PTable P_instructors = TTable::LoadSS(PAA, src_file, &Context, RelevantCols);
